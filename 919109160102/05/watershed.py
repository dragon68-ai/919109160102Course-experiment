...
def watershed(img):
    ...
    cv2.imwrite('./05/result/thresh.jpg',thresh)
    ...
    cv2.imwrite('./05/result/bg.jpg',sure_bg)
    ...
    cv2.imwrite('./05/result/fg.jpg',sure_fg)
...
# Step1. 加载图像
    img = cv2.imread('./05/house.tif')
    img1=watershed(img)

    cv2.imwrite('./05/result/img_masker.jpg',img1)
