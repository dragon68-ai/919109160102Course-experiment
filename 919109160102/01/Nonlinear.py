...
cv2.imwrite("./01/result/Nonlinear/orginal.bmp",image)
cv2.imwrite("./01/result/Nonlinear/log_img.bmp",log_img)
...
cv2.imwrite('./01/result/Nonlinear/gamma_img1.bmp',gamma_img1)
...
cv2.imwrite('./01/result/Nonlinear/gamma_img2.bmp',gamma_img2)
